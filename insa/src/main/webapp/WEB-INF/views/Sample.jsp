...
function jusoCallBack(addr1,addr2,roadAddrPart2,engAddr, jibunAddr, zip, admCd, rnMgtSn, bdMgtSn,detBdNmList,bdNm,bdKdcd,siNm,sggNm,emdNm,liNm,rn,udrtYn,buldMnnm,buldSlno,mtYn,lnbrMnnm,lnbrSlno,emdNo){
		// 팝업페이지에서 주소입력한 정보를 받아서, 현 페이지에 정보를 등록합니다.
		document.form.roadFullAddr.value = roadFullAddr;
		document.form.addr1.value = addr1;
		document.form.roadAddrPart2.value = roadAddrPart2;
		document.form.addr2.value = addr2;
...
<form name="form" id="form" method="post">
	...
	<div id="callBackDiv">
		<table>
			...
			<tr><td>도로명주소           </td><td><input type="text"  style="width:500px;" id="addr1"  name="addr1" /></td></tr>
			<tr><td>고객입력 상세주소    </td><td><input type="text"  style="width:500px;" id="addr2"  name="addr2" /></td></tr>
			...
			<tr><td>우편번호             </td><td><input type="text"  style="width:500px;" id="zip"  name="zip" /></td></tr>
